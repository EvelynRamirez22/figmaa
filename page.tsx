    ...
    <nav className="bg-[#a74122] p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center space-x-8">
          <Button
            variant={currentPage === "inicio" ? "secondary" : "ghost"}
          ...
          <Button
            variant={currentPage === "productos" ? "secondary" : "ghost"}
          ...
          <Button
            variant={currentPage === "sobre" ? "secondary" : "ghost"}
          ...
          <Button
            variant={currentPage === "contacto" ? "secondary" : "ghost"}
        ...
        return (
          <div className="max-w-4xl mx-auto p-6">
            ...
            <p className="text-black mb-8 leading-relaxed">
              ...
              hacer un libro de textos especimen. No sólo sobrevivió 500 años, sino que también ingresó como texto de
              relleno en documentos electrónicos, quedando esencialmente igual al original. Fue popularizado en los 60s
              con la creación de las hojas "Letraset", las cuales contenían pasajes de Lorem Ipsum.
            </p>
